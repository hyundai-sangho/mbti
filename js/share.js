...
console.log("isSupportedShare: " + isSupportedShare);
console.log("isSupportedClipboard: " + isSupportedClipboard);
console.log("isSupportedClipboardCommand: " + isSupportedClipboardCommand);
